 ...
 */
export type JSONSchemaDraft04TypeName = 'string' | 'number' | 'integer' | 'boolean'
                                | 'object' | 'array' | 'null' | 'any'

/**
 * @see https://tools.ietf.org/html/draft-zyp-json-schema-04#section-3.5
 */
export type JSONSchemaDraft04Type = any[] | boolean | number | null | object | string

/**
 * JSON Schema V4
 * @see https://tools.ietf.org/html/draft-zyp-json-schema-04
 */
export interface JSONSchemaDraft04 {
  id?: string
  $ref?: string
  ...
  dependencies?: {
    [k: string]: JSONSchemaDraft04 | string[]
  }
   ...
   */
  enum?: JSONSchemaDraft04Type[]

  /**
   * A single type, or a union of simple types
   */
  type?: JSONSchemaDraft04TypeName | JSONSchemaDraft04TypeName[]
